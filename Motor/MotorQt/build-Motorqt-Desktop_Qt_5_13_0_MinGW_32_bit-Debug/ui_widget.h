...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        Widget->resize(414, 337);
        pushButton = new QPushButton(Widget);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(10, 50, 75, 23));
        ...
        sufF1->setGeometry(QRect(210, 250, 47, 13));
        sufF1->setFont(font1);
        label = new QLabel(Widget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(100, 250, 101, 20));
        label->setFont(font1);
